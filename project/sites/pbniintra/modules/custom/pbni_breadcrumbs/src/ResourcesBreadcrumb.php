...
namespace Drupal\pbni_breadcrumbs;
 ...
 * {@inheritdoc}
 */
class ResourcesBreadcrumb implements BreadcrumbBuilderInterface {
  ...
  public function build(RouteMatchInterface $route_match) {
    ...
    if ($this->node) {
      ...
      $links[] = Link::fromTextandUrl(t('Resources'), Url::fromRoute('view.resources_search.resources_search_page'));
