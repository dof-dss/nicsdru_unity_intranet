 ...
 * {@inheritdoc}
 */
class NoticeboardBreadcrumb implements BreadcrumbBuilderInterface {
  ...
  public function applies(RouteMatchInterface $route_match) {
    ...
    if ($route_name == 'entity.node.canonical') {
      ...
      if (!empty($this->node)) {
        if ($this->node->bundle() == 'noticeboard') {
          $match = TRUE;
        }
      }
    }
  ...
  public function build(RouteMatchInterface $route_match) {
    ...
    if ($this->node) {
      ...
      $links[] = Link::fromTextandUrl(t('Noticeboard'), Url::fromRoute('view.noticeboard_search.noticeboard_search_page'));
